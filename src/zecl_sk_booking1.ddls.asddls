...
@EndUserText.label: 'Booking Child Entity for Travel'
@Metadata.ignorePropagatedAnnotations: true
define view entity ZECL_SK_BOOKING1 as select from /dmo/booking_m
...
association to parent ZECL_SK_TRAVEL1 as _Travel on
